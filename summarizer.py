...
def summarize_text(text, num_sentences):
    ...
    summary_ids = model.generate(inputs['input_ids'], max_length=num_sentences*30, min_length=num_sentences*20, length_penalty=2.0, num_beams=4, early_stopping=True)
...
def main():
    ...
    st.markdown("Summarize your PDF files using the T5 model from Hugging Face.")
    
    st.sidebar.header("About")
    st.sidebar.info("This app uses the T5 model from Hugging Face to generate summaries of uploaded PDF documents.")
